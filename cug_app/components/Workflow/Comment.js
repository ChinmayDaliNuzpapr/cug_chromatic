    ...
    <div className="mb-2 p-3 rounded-md border-2 w-[450px]">
      ...
      <div className="flex justify-between montserrat-10 ">
        ...
        <div className="flex justify-start">
          ...
          <div>{convertingDateValue(reply.article.createdAt)}</div>
        </div>
      </div>
    </div>
  );
...
const Comment = ({ answer }) => {
  ...
  return (
    <div className="w-100">
      <div className="my-4 p-3 rounded-md border-2 ">
        <p className="montserrat-12 mb-8">{answer.article.content}</p>

        <div className="mb-4 flex justify-between montserrat-10 ">
          <div className="flex">
            <div className="montserrat-10 mr-2">{`Posted by : ${answer.article.author}`}</div>
            <div className="mr-2">
              <div className="w-[20px] h-[20px]">
                <svg
                  // add reply toggler
          ...
          <div className="flex justify-start">
            ...
            <div>{convertingDateValue(answer.article.createdAt)}</div>
          </div>
        </div>
