...
const Question = ({ user_name, date_val }) => {
  ...
  return (
    <Link href="/questions/[id]" as={`/questions/13584`}>
      <div
      ...
      >
        <div className="-top-0 flex flex-row justify-between">
          ...
          <div className="-right-0 w-[150px] text-right">
            <span style={{ padding: "8px" }}>today</span>
          </div>
        </div>
        ...
        <div className="p-3">
          ...
          <div className="px-6 py-4">
            ...
            <span className="inline-block bg-gray-300 px-3 py-2 text-sm font-semibold text-gray-700 rounded-full">
              #cookies
            </span>
          </div>
          ...
          <div className="flex justify-between text-sm ">
            <div className="grid grid-cols-3">
              <div className="flex justify-start">
                ...
                <div className="margin_auto">views</div>
              </div>
              <div className="flex justify-start">
                <div className="w-[20px] h-[20px]">
                  <svg
              ...
              <div className="flex justify-start">
                ...
                <div className="margin_auto">comment</div>
              </div>
            </div>
            <div className="flex justify-start">
              <div>
